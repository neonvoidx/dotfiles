...
in
{
  programs.kitty = {
    ...
    extraConfig = ''
      ...
      # Scrollback nvim action alias
      action_alias kitty_scrollback_nvim kitten ~/.local/share/nvim/lazy/kitty-scrollback.nvim/python/kitty_scrollback_nvim.py
    '';
  };
  
  # Copy kitten scripts to config directory
  home.file.".config/kitty/pass_keys.py".source = ./kitty/pass_keys.py;
  home.file.".config/kitty/rename_tab.py".source = ./kitty/rename_tab.py;
  home.file.".config/kitty/get_layout.py".source = ./kitty/get_layout.py;
