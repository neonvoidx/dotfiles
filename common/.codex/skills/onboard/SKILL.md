---
name: onboard
description: '[Workflow] First-run onboarding - inspect the target profile, introduce the ecosystem, offer support packs, discover content, and collect diagnostics'
